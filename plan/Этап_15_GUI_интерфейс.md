...
- [ ] Главное окно с меню и панелями запускается
- [ ] Все 6 основных модулей реализованы (Datasets, Features, Labeling, Training, Backtesting, Experiments)
- [ ] Интеграция со всеми core-модулями платформы

### Графики и таблицы
- [ ] pyqtgraph chart отображает свечи/бары (10000+ баров без лагов)
- [ ] Zoom/Pan/Crosshair работают
- [ ] Виртуализированные таблицы (QTableView) для больших датасетов
- [ ] Индикаторы накладываются на график

### Асинхронность и многопоточность
- [ ] Долгие операции (обучение, бэктест) не блокируют UI (QThread)
- [ ] Real-time обновление логов и графиков
- [ ] Progress dialogs с возможностью отмены

### Эксперименты и оптимизация
- [ ] Batch experiments (множественные комбинации)
- [ ] Hyperparameter search интегрирован
- [ ] Strategy optimization интегрирован
- [ ] Сравнение результатов (таблицы, графики)

### UX и удобство
- [ ] Dark/Light theme переключение
- [ ] Preset management (save/load configs)
- [ ] Горячие клавиши для основных действий
- [ ] Tooltips и status bar подсказки
